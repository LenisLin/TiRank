...
from TiRank.TrainPre import Predict
from TiRank.Visualization import plot_score_distribution, plot_score_umap
...
RawDataPath = "/mnt/raid5/ProjectData/TiRank/ST/CRC/slices"
FigurePath = "/home/lenislin/Experiment/projectsResult/TiRank/bulk2st/CRC/figures"
slicesName = os.listdir(RawDataPath)
...
# --------------------------------------------
# 1. Read data iteratively and combine together
# --------------------------------------------
