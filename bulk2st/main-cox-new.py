...
pretrain_path = "/home/lyx/project/scRankv2/scRank/pretrainModel/ctranspath.pth"
...
sc_PredDF = Predict(model, bulk_GPmat=bulk_gene_pairs_mat, sc_GPmat=st_gene_pairs_mat,
                    mode=mode, sc_rownames=scAnndata.obs.index.tolist(), do_reject=True, tolerance=0.05)
