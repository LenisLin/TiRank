...
# load clinical data
bulkClinical = pd.read_table(os.path.join(dataPath,"RNAseq_prog/CRC/clinical/GSE39582_clinical_os.csv"), sep=",")
bulkClinical = bulkClinical.loc[:,["Unnamed: 0","Overall_time","Overall_event"]]
bulkClinical.head()
...
bulkExp = pd.read_csv(os.path.join(dataPath, "RNAseq_prog/CRC/exp/GSE39582_exp_os.csv"), index_col=0)
...
stPath = os.path.join(dataPath,"ST","CRC")
