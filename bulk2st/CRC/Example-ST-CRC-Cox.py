...
path_to_bulk_cli = os.path.join(
    dataPath, "RNAseq_prog/CRC/clinical/GSE39582_clinical_os.csv"
)
...
path_to_bulk_exp = os.path.join(dataPath, "RNAseq_prog/CRC/exp/GSE39582_exp_os.csv")
...
# 1.5 load ST data
path_to_st_floder = (
    "/home/lenislin/Experiment/data/scRankv2/data/ST/CRC/slices/SN048_A121573_Rep1"
)
...
pretrain_path = "/home/lenislin/Experiment/projects/scRankv2/scRank/pretrainModel/ctranspath.pth"  ## put this file in the package
