...
savePath = "/home/lenislin/Experiment/data/scRankv2/data/ST/deconv/"
ref_run_name = f'{savePath}reference_signatures/'
run_name = f'{savePath}visuim/'

# Cell2location deconvlution
# Load scRNA reference set
scPath = "/home/lenislin/Experiment/data/scRankv2/data/scRNAseq/CRC/"
...
for file_ in files:
    ...
    savepath = os.path.join("/home/lenislin/Experiment/projects/scRankv2/bulk2st/tempfiles",filename)
    stAnndata = sc.read_h5ad(os.path.join(deconv_results_path,file_))
    colname = stAnndata.obsm["q05_cell_abundance_w_sf"].columns
    colname = [x.split("_")[-1] for x in colname]
